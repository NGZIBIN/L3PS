...
public class SecondActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        al = new ArrayList<Add>();
        if(type.equals("C302")){
            al.add(new Add("C302","B", 1));
            al.add(new Add("C302","A",2));
            al.add(new Add("C302","C", 3));
            ...
            al.add(new Add("C347","B",1));
            al.add(new Add("C347","D",2));
            al.add(new Add("C347","A", 3));
        ...
        btnAdd.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
            Intent i = new Intent(SecondActivity.this, AddGrade.class);
        ...
        btnEmail.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String text = "Hi faci, I am zibin\n"  + "Please see my remarks so far thank you!\n\n";
    ...
    protected void onActivityResult(int requestCode, int 				resultCode, Intent data) {
        ...
        if(resultCode == RESULT_OK){
            if (data != null) {
                ...
                Add newCA = (Add) data.getSerializableExtra("newMG");
                al.add(newCA);
